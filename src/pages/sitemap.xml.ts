...
const pages = [
  ...
  { url: `${BASE}/productes/zones-de-gossos`,                          priority: '0.9', changefreq: 'weekly' },
  { url: `${BASE}/productes/zones-de-gossos/tanques-i-tancaments`,     priority: '0.8', changefreq: 'monthly' },
  { url: `${BASE}/productes/zones-de-gossos/equipament-de-joc`,        priority: '0.8', changefreq: 'monthly' },
  { url: `${BASE}/productes/zones-de-gossos/mobiliari-complementari`,  priority: '0.8', changefreq: 'monthly' },
  { url: `${BASE}/guia/zones-de-gossos`,                               priority: '0.9', changefreq: 'monthly' },
  ...
  { url: `${BASE}/blog/equipaments-parcs-infantils-municipis`,         priority: '0.8', changefreq: 'monthly' },
